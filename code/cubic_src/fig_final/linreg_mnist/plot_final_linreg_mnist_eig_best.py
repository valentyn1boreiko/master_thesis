...
df = pd.read_csv(
    "../linreg_mnist_old_experiments/old/loss_src_n_iter=4_delta=False_Hessian_approx=None_Solver=adaptive_sigma=100.0_delta_step=0.001_eta=0.1_LIN_REG_MNIST_adaptive_H_size=10_g_size=100.csv")
