...
df = pd.read_csv(
    "old_files/loss_src_n_iter=10_delta=False_Hessian_approx=AdaHess_Solver=adaptive_sigma=100.0_delta_step=0.001_eta=0.001_CNN_CIFAR_adaptive_H_size=10_g_size=100.csv")
