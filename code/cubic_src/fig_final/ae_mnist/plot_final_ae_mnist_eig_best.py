...
df = pd.read_csv("loss_src_n_iter=1_delta=False_Hessian_approx=AdaHess_Solver=Linear_system_sigma=1.0_delta_step=0.001_eta=0.1_AE_MNIST_Linear_system_H_size=10_g_size=100.csv")
